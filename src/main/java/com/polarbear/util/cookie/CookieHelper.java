...
public class CookieHelper {
    ...
    public static void removeCookie(HttpServletResponse response, String name, String domain) {
        Cookie cookie = new Cookie(name, "");
        removeCookie(response, cookie, domain);
    }
    ...
    public static void setCookie(HttpServletResponse response, String name, String value) {
        setCookie(response, name, value, null, COOKIE_MAX_AGE);
    }
    ...
    /**
     * @desc 添加一条新的Cookie信息，可以设置域名（用于顶级域跨域）
     * @param response
     * @param name
     * @param value
     * @param domain
    ...
    public static void setCookie(HttpServletResponse response, String name, String value, String domain) {
        setCookie(response, name, value, domain, COOKIE_MAX_AGE);
    }

    /**
     * @desc 添加一条新的Cookie信息，可以设置域名（用于顶级域跨域），可以设置其最长有效时间(单位：秒)
     * @param response
     * @param name
     * @param value
     * @param domain
